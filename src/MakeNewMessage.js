...
const MakeNewMessage = ({email, handleNewMessageSubmit, handleSeeList, password}) => {
  ...
  var assembleMessage = () => {
    ...
    handleNewMessageSubmit(messageObject);
  }
